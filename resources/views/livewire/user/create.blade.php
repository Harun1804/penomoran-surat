                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" placeholder="Masukan Username" wire:model="username" value="{{ old('username') }}">
                                @error('username')
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Masukan Email" wire:model="email" value="{{ old('email') }}">
                                @error('email')
                        ...
                        <div class="col-md-12">
                            <div class="form-check">
                                ...
                                <label class="form-radio-label">
                                    <input class="form-radio-input" type="radio" name="role" value="admin" wire:model="role">
                                    <span class="form-radio-sign">Admin</span>
                                </label>
                                <label class="form-radio-label ml-3">
                                    <input class="form-radio-input" type="radio" name="role" value="staff" wire:model="role">
